...
const OfficeDetails: React.FC = () => {
  ...
  return (
    <div style={{ background: '#FFFFFF', padding: '20px', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
      {office && (
        <>
          <h2 style={{ color: '#333', borderBottom: '1px solid #E1E1E1', paddingBottom: '10px' }}>{office.name}</h2>
